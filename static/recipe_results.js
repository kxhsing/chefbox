      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          for (i = 0; i < data.recipe_results_list.length; i++) {
            ...
            $(newFooter).append('<form action="/add_recipe" method="POST"><button type="submit" class="add-recipe btn btn-primary" name="recipe_id" value="'+recipeID+'">Save Recipe</button></form>');
            $(newFooter).appendTo(newDiv);
